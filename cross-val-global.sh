...
DOMAIN_PATH=$PROJECT_DIR/src/data/external/global/domain.csv
CENTROIDS_PATH=$PROJECT_DIR/src/data/external/global/country-centroids.csv
...
python cross-validate.py data/processed/global/100ITS.biom models/global/100-coarse-cross-val.csv \
...
python cross-validate.py data/processed/global/trnL.biom models/global/coarse-cross-val.csv \
    --seeds='coarse' --folds=$FOLDS --partitions=$PARTS --domain-fp=$DOMAIN_PATH \
    --region=0.5 --region=0.75 --region=0.9 --taxa-threshold=$TAXA_THRESHOLD \
    --area='country' --area='locality' --area='administrative_area_level_1' \
    --area='administrative_area_level_2' --area='administrative_area_level_3' \
...
python cross-validate.py data/processed/global/trnL.biom models/global/fine-cross-val.csv \
...
# python cross-validate.py data/processed/global/ITS.biom models/global/coarse-cross-val.csv \
    # --seeds='coarse' --folds=$FOLDS --partitions=$PARTS --domain-fp=$DOMAIN_PATH \
    # --region=0.5 --region=0.75 --region=0.9 --taxa-threshold=$TAXA_THRESHOLD \
    # --area='country' --area='locality' --area='administrative_area_level_1' \
    # --area='administrative_area_level_2' --area='administrative_area_level_3' \
...
# python cross-validate.py data/processed/global/ITS.biom models/global/fine-cross-val.csv \
    # --seeds='fine' --folds=$FOLDS --partitions=$PARTS --domain-fp=$DOMAIN_PATH \
    # --region=0.5 --region=0.75 --region=0.9 --taxa-threshold=$TAXA_THRESHOLD \
    # --area='country' --area='locality' --area='administrative_area_level_1' \
    # --area='administrative_area_level_2' --area='administrative_area_level_3' \
...
# python cross-validate.py data/processed/global/ITS.biom models/global/mixed-cross-val.csv \
    # --seeds='mixed' --folds=$FOLDS --partitions=$PARTS --domain-fp=$DOMAIN_PATH \
    # --region=0.5 --region=0.75 --region=0.9 --taxa-threshold=$TAXA_THRESHOLD \
    # --area='country' --area='locality' --area='administrative_area_level_1' \
    # --area='administrative_area_level_2' --area='administrative_area_level_3' \
...
# python cross-validate.py data/processed/global/100ITS.biom models/global/100-fine-cross-val.csv \
    # --seeds='fine' --folds=$FOLDS --partitions=$PARTS --domain-fp=$DOMAIN_PATH \
    # --region=0.5 --region=0.75 --region=0.9 --taxa-threshold=$TAXA_THRESHOLD \
    # --area='country' --area='locality' --area='administrative_area_level_1' \
    # --area='administrative_area_level_2' --area='administrative_area_level_3' \
...
# python cross-validate.py data/processed/global/100ITS.biom models/global/100-mixed-cross-val.csv \
    # --seeds='mixed' --folds=$FOLDS --partitions=$PARTS --domain-fp=$DOMAIN_PATH \
    # --region=0.5 --region=0.75 --region=0.9 --taxa-threshold=$TAXA_THRESHOLD \
    # --area='country' --area='locality' --area='administrative_area_level_1' \
    # --area='administrative_area_level_2' --area='administrative_area_level_3' \
