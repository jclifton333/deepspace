...
def summarize_cross_validation(inputs):
    ...
    for input_ in inputs:
        ...
        if df['seeds'].unique() == 'none':
            ...
            areas = ['over_country', 'over_locality', 'over_administrative_area_level_2','over_administrative_area_level_3','over_administrative_area_level_4','over_administrative_area_level_5']
