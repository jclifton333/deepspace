...
DOMAIN_PATH=$PROJECT_DIR/src/data/external/local/domain.csv
...
python cross-validate.py data/processed/local/ITS-outdoor.biom models/local/none-cross-val.csv \
